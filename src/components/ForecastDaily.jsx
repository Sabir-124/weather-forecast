...
function ForecastDaily({ data }) {
  const { day, icon, temperature_min, temperature_max, precipitation, wind } =
    data;
    ...
    <div className="forecast-hourly">
      ...
      <div className="icon-temp">
        <div className="weather-icons">
          <img
            className="we-icon"
            src={`/weather-forecast/weather_icons/set03/big/${icon}.png`}
            alt="weather icon"
          />
        </div>
        <div className="temp">
      ...
      <div className="wind">
        <img
          className="wind-icon"
          src="/weather-forecast/logos/wind.png"
          alt="wind icon"
        />
        <div>
